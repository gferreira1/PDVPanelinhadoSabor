...
export function montarEstruturaPedidos() {
...
export async function carregarPedidos() {
        ...
        <div class="pedido-info">
            ...
            ${status === "recebido" ? `
              <div class="dropdown ms-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li><a class="dropdown-item text-danger" href="#" onclick="excluirPedido('${pedido.id}')">🗑 Cancelar Pedido</a></li>
                </ul>
              </div>
            ` : ""}
          </div>
          ...
          <div class="detalhes-pedido ${status !== "finalizado" ? "show" : ""}">
            <div class="border-top pt-2 mt-2">
              ...
              <ul class="list-unstyled ps-3">${itensFormatados}</ul>
  ...
  document.querySelector(".recebido-header").innerHTML = `<i class="bi bi-hourglass-top me-2"></i>Recebido (${totalRecebidos})`;
  document.querySelector(".producao-header").innerHTML = `<i class="bi bi-gear-wide-connected me-2"></i>Em Produção (${totalProducao})`;
  document.querySelector(".finalizado-header").innerHTML = `<i class="bi bi-check-circle me-2"></i>Finalizado (${totalFinalizadosMes})`;
}
